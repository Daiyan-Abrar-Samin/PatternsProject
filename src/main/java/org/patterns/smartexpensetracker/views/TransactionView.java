...
public class TransactionView extends BorderPane {
    ...
    private final Integer userIdFilter;

    // Normal user
    public TransactionView(TransactionController controller) {
        this(controller, false, null);
    }

    // Admin view
    public TransactionView(TransactionController controller, boolean readOnly, Integer userIdFilter) {
    ...
    public void refreshTable() {
        if (readOnly && userIdFilter != null) {
            tableView.setItems(controller.getTransactionsByUser(userIdFilter));
        } else {
